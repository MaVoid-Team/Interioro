...
class SpecialPieceRequest extends Model<
  InferAttributes<SpecialPieceRequest>,
  InferCreationAttributes<SpecialPieceRequest>
> {
  ...
  declare desiredPieceType: string;
...
SpecialPieceRequest.init(
  ...
  {
    sequelize,
    tableName: "special_piece_requests",
    timestamps: true,
    underscored: true,
  }
);

export default SpecialPieceRequest;
